...
TRAINING_CLASS = ['AK','BCC','BKL','DF','MEL','NV','SCC','UNK','VASC'] 
VAL_CLASS = ['AK','BCC','BKL','DF','MEL','NV','SCC','UNK','VASC'] 
NUM_CLASSES = 9
...
OUTPUT_PATH = '../data/wgan_output' # output path where result (.e.g drawing images, cost, chart) will be stored
# MODE = 'wgan-gp'
...
def load_data(path_to_folder, classes):
    ...
    dataset_loader = torch.utils.data.DataLoader(dataset,batch_size=BATCH_SIZE, shuffle=False, num_workers=5, drop_last=True, pin_memory=True, sampler=sampler)
